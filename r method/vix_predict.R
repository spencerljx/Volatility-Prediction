...
datav = ts(data)[1:252*4,5] # the data from 1/2/2014 to 12/31/2014
plot(datav)
## choose a trend
TIME = c(1:252*4)
TIME2 = TIME*TIME
...
summary(result4)
AIC(result1) #1479.68
AIC(result2) #1417.526
AIC(result3) #1416.422
AIC(result4) #1462.607
...
vix.garch10=garch(datav.detrend,order=c(1,0))
vix.garch01=garch(datav.detrend,order=c(0,1))
vix.garch11=garch(datav.detrend,order=c(1,1))
...
print(AIC(vix.garch11))
print(AIC(vix.garch01))
print(AIC(vix.garch10))
##forecast
time=c(253:299)
time2=time*time
#ar1
vix.ar1=Arima(datav.detrend,order=c(1,0,1))
...
#one replacement
fcst2=rep(vix.ar1$coef[2],47)+vix.ar1$coef[1]*data[252:298,5]
fcstdata2=trend+fcst2
#plot the lines of real and fsct
datav2=ts(data)[253:299,5]
